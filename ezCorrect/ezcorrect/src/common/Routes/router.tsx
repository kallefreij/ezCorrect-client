    ...
    return (
        <HashRouter>
            ...
            <Switch>
                ...
                <ProtectedRoute exact path="/teacher/assignments" isAuthenticated={props.loggedIn} component={Assignments}/>
                <ProtectedRoute exact path="/teacher/assignments/create" isAuthenticated={props.loggedIn} component={CreateAssignment}/>
                <ProtectedRoute exact path="/teacher/assignments/correct" isAuthenticated={props.loggedIn} component={CorrectAssignment}/>
                <ProtectedRoute exact path="/teacher/groups" isAuthenticated={props.loggedIn} component={Groups}/>
                <ProtectedRoute exact path="/teacher/group" isAuthenticated={props.loggedIn} component={Group}/>
