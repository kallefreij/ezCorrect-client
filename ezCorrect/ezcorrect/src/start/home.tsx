  ...
  return (
    <div>
      ...
      <section className="green textWhite">
        ...
        <p>
          Ab, ratione id? Quo et mollitia distinctio molestiae. Neque labore quo
          voluptas. Deleniti repellat laboriosam minus tempora. Obcaecati, unde
          corporis sint deleniti neque, aspernatur quam iure iusto nemo
      ...
      <section className="darkgreen textWhite">
        <h1>nice curves</h1>
        <p>
          Repellendus quas, perspiciatis hic omnis officiis perferendis!
          Doloremque ipsam praesentium eaque reiciendis optio molestias impedit,
          corrupti, commodi placeat asperiores error pariatur? Ipsam adipisci
          recusandae omnis quo a. Nostrum, perspiciatis quo?
        </p>
      </section>
    </div>
  );
