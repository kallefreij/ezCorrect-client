...
const Home:React.FC = () => (
    <div>
        <section className='imageBackground'>
            ...
            <h1>nice curves</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt recusandae, perspiciatis illo in molestias quam. Delectus, labore. Qui, repudiandae! Id nam distinctio obcaecati vitae dolores modi quo suscipit enim quam.</p> */}
