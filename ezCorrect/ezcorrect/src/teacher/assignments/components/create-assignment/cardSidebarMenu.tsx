        ...
        <ThemeProvider theme={blueTheme}>
            <Card className={classes.main}>
                <CardContent className={classes.content}>
                    ...
                    <Button variant="contained" onClick={handleSave} className={classes.button} color="primary" disabled={loading}>
                        <SaveIcon/>
                        Spara prov
                    ...
                    <Button variant="outlined" onClick={handleDisable} color={isDraggableDisabled ? 'secondary' : 'primary'} className={classes.button} >
                        <FormControlLabel
                            control={<Switch checked={isDraggableDisabled} onChange={handleDisable}/>}
                            label=""
                        />
